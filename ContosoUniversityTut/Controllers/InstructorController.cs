...
using ContosoUniversityTut.ViewModels;
    ...
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseID)
        {
            ...
            if (courseID != null)
            {
                ...
                db.Entry(selectedCourse).Collection(x => x.Enrollments).Load();//Load enrollment tuong ung voi course ID, dua vao selectedCourse
                foreach (Enrollment enrollment in selectedCourse.Enrollments)
                {
                    db.Entry(enrollment).Reference(x => x.Student).Load();//Load 1 entity thi dung Reference
                    /*
